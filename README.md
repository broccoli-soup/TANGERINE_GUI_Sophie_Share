...
- To test that it works, feel free to use the NON_PHI_EXAMPLE_256x256x256.nii.gz file, which can be found at https://drive.google.com/file/d/1H0ghash-lTVrEKfuu05wZ44qPJB1qZE9/view?usp=sharing 
